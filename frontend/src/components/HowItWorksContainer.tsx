  ...
  return (
    <section className="flex flex-col items-center justify-start py-0 px-5 box-border gap-[56px] max-w-full shrink-0 text-center text-37xl text-mediumpurple font-heading-05 mq700:gap-[28px]">
      <div className="w-[600px] flex flex-row items-start justify-start max-w-full">
        <h1 className="m-0 w-[551px] text-violet-400 text-[58px] relative text-inherit tracking-[0.5px] leading-[64px] font-normal font-inherit inline-block shrink-0 max-w-full mq450:text-15xl mq450:leading-[38px] mq900:text-26xl mq900:leading-[51px]">
          ¿How does it work?
        </h1>
      </div>
